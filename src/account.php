...
$title = 'Account | ' . $TITLE;
$keywords = 'Profilo utente, account, Clue Catchers, cambia password, cambia username';
$description = 'Visualizza il tuo profilo utente e cambia le tue credenziali di accesso.';
