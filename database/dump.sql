...
CREATE TABLE `capitolo` (
  ...
  CONSTRAINT `capitolo_ibfk_1` FOREIGN KEY (`idIndagine`) REFERENCES `indagine` (`id`) ON UPDATE CASCADE
...
INSERT INTO `capitolo` VALUES ('0000000000000001','0000000000000001',1,'Indagine nel salone','<p>Il primo obiettivo &egrave; concentrarsi sul furto e capirne la dinamica, perci&ograve; l&apos;indagine inizia nel luogo del furto: ti trovi nel salone da ballo, ora adibito a sala da pranzo per l&apos;evento di cena al buio. Nuove prove sono state rinvenute sul luogo e aggiunte alla collezione. Rispondi alle domande per proseguire al prossimo capitolo.</p>'),('0000000000000002','0000000000000001',2,'Indagine nello studio','<p>Ora &egrave; il momento di focalizzarsi sulla dinamica del delitto: ti trovi nello studio, l&apos;ambiente &egrave; stato messo a soqquadro e il pavimento ha diversi fogli sparsi nel terreno, provenienti da cartelle di documenti estratte dagli archivi. Le nuove prove sono state aggiunte alla collezione, pronte per essere esaminate per rispondere alle domande.</p>\r\n'),('0000000000000003','0000000000000001',3,'Indagine nel giardino d\'inverno','<p>Ti stai avvicinando alla conclusione del caso! Hai esaminato le stanze principali e ti sei spostato nel giardino d&apos;inverno per osservare pi&ugrave; da vicino il famoso orto botanico della villa, di cui hai tanto sentito parlare.</p>\r\n<p>Ci sono ancora dei dubbi che ti sono rimasti impressi, utilizza le prove collezionate finora per scoprire se possono aiutarti a risolvere il caso.</p>'),('0000000000000004','0000000000000001',0,'Partenza','<p>Che l&apos;indagine abbia inizio!</p>\r\n<p>\r\nOgni capitolo consiste di una serie di domande a cui dovrai rispondere utilizzando le prove collezionate.\r\nAll&apos;inizio di ogni nuovo capitolo avrai delle nuove prove da esaminare oltre a quelle che hai gi&agrave; ottenuto.\r\nIl tuo primo compito &egrave; esaminare le prove di partenza fornite dal cliente e dalla polizia per rispondere alla prima domanda\r\n</p>\r\n<p lang=\"en\">Good luck!</p>'),('0000000000000005','0000000000000001',4,'Caccia al ladro','<p>Incredibile ma vero, hai scoperto un passaggio segreto! Assolutamente non un clich&eacute;, ma sembra proprio che la vecchia libreria nascondesse un segreto sotto alla pila di libri polverosi.</p>\r\n<p>&Egrave; il momento della verit&agrave;: con le nuove prove ottenute, devi decidere chi ha commesso il furto.</p>'),('0000000000000006','0000000000000001',5,'Trova il colpevole','<p>Matilde ha confessato di aver commesso il furto! Puoi trovare un riassunto della sua versione tra le prove.</p>\r\n<p>Ed ora &egrave; arrivato il momento di scovare l&apos;assassino. Con tutte le prove accumulate, sarai in grado di trovare la persona giusta?</p>\r\n');
...
CREATE TABLE `documentoiniziale` (
  ...
  KEY `idIndagine` (`idIndagine`),
  CONSTRAINT `documentoiniziale_ibfk_1` FOREIGN KEY (`idIndagine`) REFERENCES `indagine` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `domanda` (
  ...
  CONSTRAINT `domanda_ibfk_1` FOREIGN KEY (`idCapitolo`) REFERENCES `capitolo` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `domanda` VALUES ('0000000000000001',1,'0000000000000004','È possibile che un esterno si sia introdotto nella villa?'),('0000000000000002',1,'0000000000000001','Quando è uscito Edgardo?'),('0000000000000003',2,'0000000000000001','Come è stata rotta la teca?'),('0000000000000004',3,'0000000000000001','Dove si trovava chi ha rotto il vetro?'),('0000000000000005',4,'0000000000000001','Quando è stato rubato il cofanetto?'),('0000000000000006',5,'0000000000000001','Chi non avrebbe potuto rubarlo?'),('0000000000000007',1,'0000000000000002','Chi poteva introdursi nello studio dopo l\'interruzione di corrente?'),('0000000000000008',2,'0000000000000002','È plausibile la teoria del suicidio'),('0000000000000009',3,'0000000000000002','Cosa ci faceva un guscio di petardo nello studio?'),('0000000000000010',4,'0000000000000002','Per quale motivo c\'è un buco sul piumino?'),('0000000000000011',5,'0000000000000002','Cosa indicano i movimenti nel frammento di libro contabile?'),('0000000000000012',6,'0000000000000002','Chi avrebbe potuto covare rancore verso Edgardo?'),('0000000000000013',7,'0000000000000002','Quando è avvenuto il decesso?'),('0000000000000014',1,'0000000000000003','A cosa sono dovuti i rumori nei muri della casa?'),('0000000000000015',2,'0000000000000003','Quali sono le uscite dal giardino d’inverno?'),('0000000000000016',1,'0000000000000005','Chi ha compiuto il furto?'),('0000000000000017',1,'0000000000000006','Chi ha ucciso Edgardo?');
...
INSERT INTO `indagine` VALUES ('0000000000000001','2024-01-11 22:02:06','Cena al buio con delitto','Indaga sullo strabiliante caso irrisolto dell\'omicidio del signor Edgardo e scopri l\'assassino e il movente!','/images/indagine1/cover.png');
...
CREATE TABLE `prova` (
  ...
  KEY `idIndagine` (`idIndagine`),
  KEY `idCapitolo` (`idCapitolo`),
  CONSTRAINT `prova_ibfk_1` FOREIGN KEY (`idIndagine`) REFERENCES `indagine` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `prova_ibfk_2` FOREIGN KEY (`idCapitolo`) REFERENCES `capitolo` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `provadimostra` (
  ...
  CONSTRAINT `provadimostra_ibfk_1` FOREIGN KEY (`idProva`) REFERENCES `prova` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `provadimostra_ibfk_2` FOREIGN KEY (`idDomanda`) REFERENCES `domanda` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `provadimostra` VALUES ('0000000000000001','0000000000000014'),('0000000000000002','0000000000000002'),('0000000000000002','0000000000000005'),('0000000000000002','0000000000000006'),('0000000000000002','0000000000000015'),('0000000000000004','0000000000000009'),('0000000000000005','0000000000000007'),('0000000000000006','0000000000000003'),('0000000000000006','0000000000000004'),('0000000000000007','0000000000000012'),('0000000000000007','0000000000000014'),('0000000000000007','0000000000000016'),('0000000000000009','0000000000000004'),('0000000000000010','0000000000000001'),('0000000000000010','0000000000000002'),('0000000000000010','0000000000000006'),('0000000000000010','0000000000000007'),('0000000000000011','0000000000000008'),('0000000000000012','0000000000000008'),('0000000000000013','0000000000000011'),('0000000000000014','0000000000000003'),('0000000000000015','0000000000000005'),('0000000000000016','0000000000000012'),('0000000000000017','0000000000000009'),('0000000000000017','0000000000000013'),('0000000000000018','0000000000000010'),('0000000000000018','0000000000000013'),('0000000000000019','0000000000000011'),('0000000000000019','0000000000000012'),('0000000000000020','0000000000000012'),('0000000000000021','0000000000000010'),('0000000000000022','0000000000000015'),('0000000000000022','0000000000000016'),('0000000000000023','0000000000000017'),('0000000000000024','0000000000000017');
...
CREATE TABLE `recensione` (
  ...
  KEY `idIndagine` (`idIndagine`),
  CONSTRAINT `recensione_ibfk_1` FOREIGN KEY (`idUtente`) REFERENCES `utente` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `recensione_ibfk_2` FOREIGN KEY (`idIndagine`) REFERENCES `indagine` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recensione` VALUES (16,'0000000000000001','Top 5 storie in questo sito!','2024-01-30 11:03:15'),(17,'0000000000000001','No vabbè non l\'avrei mai detto!','2024-01-30 11:11:14'),(18,'0000000000000001','Si può fare di meglio','2024-01-30 12:21:02');
...
CREATE TABLE `risposta` (
  ...
  CONSTRAINT `risposta_ibfk_1` FOREIGN KEY (`idDomanda`) REFERENCES `domanda` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `risposta` VALUES ('0000000000000001',1,'0000000000000001',0,'Si'),('0000000000000002',2,'0000000000000001',1,'No'),('0000000000000003',1,'0000000000000002',0,'Non è mai uscito'),('0000000000000004',2,'0000000000000002',0,'Durante l\'apericena'),('0000000000000005',3,'0000000000000002',0,'Durante il blackout'),('0000000000000006',4,'0000000000000002',1,'A inizio cena'),('0000000000000007',1,'0000000000000003',0,'Spingendolo a terra'),('0000000000000008',2,'0000000000000003',0,'Con una bottiglia d\'acqua'),('0000000000000009',3,'0000000000000003',1,'Con una damigiana'),('0000000000000010',4,'0000000000000003',0,'Con un sasso'),('0000000000000011',1,'0000000000000004',0,'Nel salone'),('0000000000000012',2,'0000000000000004',1,'Al piano di sopra'),('0000000000000013',3,'0000000000000004',0,'Nell\'ingresso'),('0000000000000014',4,'0000000000000004',0,'In giardino'),('0000000000000015',1,'0000000000000005',0,'Prima dell\'apericena'),('0000000000000016',2,'0000000000000005',1,'Durante la cena'),('0000000000000017',3,'0000000000000005',0,'Dopo aver rotto la teca'),('0000000000000018',4,'0000000000000005',0,'Dopo il blackout'),('0000000000000019',1,'0000000000000006',0,'Armando'),('0000000000000020',2,'0000000000000006',1,'Edgardo'),('0000000000000021',3,'0000000000000006',0,'Genoveffa'),('0000000000000022',4,'0000000000000006',0,'Ermenegildo'),('0000000000000023',1,'0000000000000007',1,'Tutti'),('0000000000000024',2,'0000000000000007',0,'Edgardo'),('0000000000000025',3,'0000000000000007',0,'Edgardo, Ermenegildo'),('0000000000000026',4,'0000000000000007',0,'Edgardo, Ermenegildo, Genoveffa'),('0000000000000027',1,'0000000000000008',0,'Si'),('0000000000000028',2,'0000000000000008',1,'No'),('0000000000000029',1,'0000000000000009',0,'Per spaventare Edgardo'),('0000000000000030',2,'0000000000000009',0,'Per festeggiare capodanno'),('0000000000000031',3,'0000000000000009',0,'È sempre stato lì '),('0000000000000032',4,'0000000000000009',1,'Per sviare le indagini'),('0000000000000033',1,'0000000000000010',0,'Per una bruciatura di sigaretta'),('0000000000000034',2,'0000000000000010',0,'A causa di una scintilla del camino'),('0000000000000035',3,'0000000000000010',0,'Un buco del ferro da stiro'),('0000000000000036',4,'0000000000000010',1,'Per attutire un suono'),('0000000000000037',1,'0000000000000011',1,'Appropriazione indebita'),('0000000000000038',2,'0000000000000011',0,'Un’azienda in difficoltà economica'),('0000000000000039',3,'0000000000000011',0,'Contabilità inattendibile'),('0000000000000040',4,'0000000000000011',0,'Troppe spese'),('0000000000000041',1,'0000000000000012',1,'Un socio'),('0000000000000042',2,'0000000000000012',0,'Genoveffa'),('0000000000000043',3,'0000000000000012',0,'Gli spiriti'),('0000000000000044',4,'0000000000000012',1,'Ermenegildo'),('0000000000000045',5,'0000000000000013',0,'Armando'),('0000000000000046',1,'0000000000000013',0,'Prima dell’apericena'),('0000000000000047',2,'0000000000000013',1,'Prima del rumore di sparo'),('0000000000000048',3,'0000000000000013',0,'Durante il rumore di sparo'),('0000000000000049',4,'0000000000000013',0,'Dopo il rumore di sparo'),('0000000000000050',1,'0000000000000014',0,'Vecchie tubature'),('0000000000000051',2,'0000000000000014',1,'Bambini nelle mura'),('0000000000000052',3,'0000000000000014',0,'Roditori'),('0000000000000053',4,'0000000000000014',0,'Lo spirito di Vittorio Trevisan'),('0000000000000054',1,'0000000000000015',0,'Una verso il salone e una verso il giardino esterno'),('0000000000000055',2,'0000000000000015',0,'Due verso il salone, una verso il giardino esterno'),('0000000000000056',3,'0000000000000015',1,'Una verso l’interno, una verso il salone e una verso il giardino esterno'),('0000000000000057',4,'0000000000000015',0,'Un accesso alle cantine'),('0000000000000058',1,'0000000000000016',0,'Armando'),('0000000000000059',2,'0000000000000016',0,'Lucrezia'),('0000000000000060',3,'0000000000000016',1,'Matilde'),('0000000000000061',4,'0000000000000016',0,'Eriberto'),('0000000000000062',5,'0000000000000016',0,'Mariangela'),('0000000000000063',6,'0000000000000016',0,'Ermenegildo'),('0000000000000064',7,'0000000000000016',0,'Genoveffa'),('0000000000000065',8,'0000000000000016',0,'Gli spiriti'),('0000000000000066',1,'0000000000000017',0,'Armando'),('0000000000000067',2,'0000000000000017',0,'Lucrezia'),('0000000000000068',3,'0000000000000017',0,'Matilde'),('0000000000000069',4,'0000000000000017',0,'Eriberto'),('0000000000000070',5,'0000000000000017',0,'Mariangela'),('0000000000000071',6,'0000000000000017',1,'Ermenegildo'),('0000000000000072',7,'0000000000000017',0,'Genoveffa'),('0000000000000073',8,'0000000000000017',0,'Gli spiriti'),('0000000000000074',5,'0000000000000012',0,'Armando');
...
CREATE TABLE `salvataggio` (
  ...
  KEY `progressivoDomanda` (`idDomanda`),
  CONSTRAINT `salvataggio_ibfk_1` FOREIGN KEY (`idUtente`) REFERENCES `utente` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `salvataggio_ibfk_2` FOREIGN KEY (`idDomanda`) REFERENCES `domanda` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `salvataggio_ibfk_3` FOREIGN KEY (`idIndagine`) REFERENCES `indagine` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `salvataggio` VALUES ('0000000000000001',16,NULL),('0000000000000001',17,NULL),('0000000000000001',18,NULL);
...
-- Dump completed on 2024-01-30 15:52:17
